        ...
        if (player.isAlive) {
            ...
            if (game.nightNum == 1) {
                guild.channels
                    ...
                    .catch(console.error)
                    .then((msgg) => {
                        msgg.react('701404681913499688')
                            .then(() => msgg.react('722541136392224778'))
                            .then(() => msgg.react('722540328027947119'))
                        const filter = (reaction, user) => {
                            return (
                                ['Villager', 'Werewolf', 'Neutral'].includes(
                                    reaction.emoji.name
                                ) && user.id === player.id
                            )
                        }
                        ...
                        collector.on('collect', (reaction, user) => {
                            ...
                            if (reaction.emoji.name === 'Villager') {
                                ...
                                console.log(
                                    player.displayName +
                                        ' has selected Village as the Nostradamus.'
                                )
                                ...
                                console.log(
                                    player.displayName +
                                        ' has selected Werewolves as the Nostradamus.'
                                )
                                ...
                                console.log(
                                    player.displayName +
                                        ' has selected Neutral as the Nostradamus.'
                                )
                            }
                        })
                        ...
                        collector.on('end', (collected) => {
                            if (variableName != null) {
                                ...
                                guild.channels
                                    ...
                                    .send(
                                        '```fix\n' +
                                            'You were randomly assigned the ' +
                                            variableName +
                                            ' team.' +
                                            '```'
                                    )
            ...
            if (!usedImmunity.includes(player)) {
                guild.channels
                    ...
                    .send(
                        '```css\n' +
                            'Select if you would like to gain immunity.' +
                            '```'
                    )
                    .catch(console.error)
                    .then((msgg) => {
                        ...
                        collector.on('collect', (reaction, user) => {
                            ...
                            if (reaction.emoji.name === '✅') {
                                ...
                                console.log(
                                    player.displayName +
                                        ' has selected Gain Immunity as the Nostradamus.'
                                )
